...
function ProtectedRoute({ children, requireAuth = true, requirePartner = false, requireAdmin = false }) {
...
function App() {
  ...
  useEffect(() => {
    ['navigateTo', 'handleLogin', 'initMap', 'loadBottomNavigation', 'loadBottomNav']
      .forEach((fn) => {
