  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        setError(result.error || result.message || 'Failed to reschedule booking');
      }
    } catch (err) {
        ...
        <div className="elizian-auth-modal" style={{ maxWidth: '600px' }}>
          ...
          <form className="elizian-auth-form" onSubmit={handleSubmit}>
            ...
            <div className="elizian-auth-form-group">
              ...
              {newDate && !newTime && (
                <small style={{ color: '#d97706', fontSize: '0.85rem', marginTop: '0.25rem', display: 'block' }}>
                  ⚠️ Please select a time. If not provided, it will default to 12:00 AM.
                </small>
              )}
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '0.9rem', color: '#856404' }}>
                <strong>Note:</strong> Rescheduling may be subject to availability and partner policies. 
                The original booking will be cancelled and a new booking will be created.
              </div>
            </div>
